...
from .nodeset_template_formatter_lxml import generate_nodeset_xml_from_nodes
# or:
# from .nodeset_template_formatter_xmltree import generate_nodeset_xml_from_nodes
